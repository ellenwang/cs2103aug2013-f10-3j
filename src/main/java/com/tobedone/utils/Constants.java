...
public class Constants {
	...
	// GoogleSync
	public static final String MESSAGE_DOWNLOAD_SUCCESS = "The local tasks have been updated.";
	public static final String MESSAGE_UPLOAD_SUCCESS = "The Google calendar has been updated.";
	...
	public static final String DEAFAULT_CALENDAR = "primary";
	// Storage
