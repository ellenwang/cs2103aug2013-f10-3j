...
public class Constants {
	...
	public static final String STRING_PRI_LOW = "9";
	public static final String STRING_PRI_MED = "10";
	public static final String STRING_PRI_HIGH = "11";
	...
	public static final String TIP_BEGIN = "Type help/? to get information about how to use the product.";
	public static final String TIP_FINISH = "finish [index]";
	...
	public static final String STATUS_UNFINISHED = "    -";
	...
	public static final String MSG_ERROR_INVALID_COMMAND = "No such command :(";
	...
	// help
	public static final String HELP_ADD = "How to Add a task into 2BeDone:\n"
			+ "in 2BeDone you can follow the add command format to add a task\n\n"
			+ "add/+ [Description] (Priority)                                     :   Task without time constraint\n"
			+ "                               from [Date1] to [Date2] (Priority)  :   Task with start and end time\n"
			+ "                               by [Date] (Priority)                        :   Task with deadline\n\n"
			+ "Here [ ] means must have, () means optional.\n"
			+ "For [Date] format, refer to TimeFormat help.\n\n" + "Example:\n"
			+ "	+ attend tutorial class from 11am to 12am ";
	public static final String HELP_SYNC = "How to sync with Google Calendar\n\n"
			+ "There are two way to sync with your google calendar\n"
			+ "1. upload       :export your tasks in 2BeDone to Google calendar\n"
			+ "2. download  :import tasks in Google calendar into 2BeDone\n\n"
			+ "Command format:\n" + "\tupload\n" + "\tdownload\n";
	public static final String HELP_TIME = "About Time format\n"
			+ "Time: (time) (day)\n"
			+ "time:\n"
			+ "HH:mm                 -> 9:00   14:33\n"
			+ "HH:mm(am/pm)   ->9:33am   11:33pm\n"
			+ "HH(am/pm)           ->9pm   13pm\n\n"
			+ "day\n"
			+ "(this/next) mon tues wed thur fri sat sun(the full name is ok too)\n"
			+ "today/tomorrow\n"
			+ "dd-mm             ->12-11\n"
			+ "dd-mm-yyyy    ->12-11-2014\n\n"
			+ "Example:\n"
			+ "9pm this fri         9:30 monday         9:33 12-12             8:33pm 12-12-2013";
	public static final String HELP_URDO = "undo:   cancel last operation (add, remove, update, finish)\n"
			+ "redo   cancel last undo";

	public static final String HELP_OTHER = "Other Command\n\n"
			+ "remove [index]                   	: delete a task\n"
			+ "finish [index]                       	: complete a task, change the status into finished\n"
			+ "list [all/finished/unfinished] 	: view tasks satisfy the condition\n\n"
			+ "update [index] [(description) (from Date) (to Date) (by Date) (priority)]\n"
