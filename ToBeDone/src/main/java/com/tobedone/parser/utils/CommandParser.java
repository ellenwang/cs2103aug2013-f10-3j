...
public class CommandParser {
	 ...
	 */
	//
	protected Date parseDate(String datePattern) throws Exception {
	...
	private int getFutureDay(String dayofweek){
		...
		if(dayofweek.equals("today")){
			...
			if(currentDayOfaWeek>Calendar.MONDAY){
				return currentday+Calendar.MONDAY-currentDayOfaWeek + addDays1  + 7;
			}else{
				return currentday+Calendar.MONDAY-currentDayOfaWeek + addDays2 ;
			}
		}else if(dayofweek.equals("tues")||dayofweek.equals("tuesday")){
			if(currentDayOfaWeek>Calendar.TUESDAY){
				return currentday+Calendar.TUESDAY-currentDayOfaWeek + addDays1  + 7;
			}else{
				return currentday+Calendar.TUESDAY-currentDayOfaWeek + addDays2 ;
			}

		}else if(dayofweek.equals("wed")||dayofweek.equals("wednesday")){
			if(currentDayOfaWeek>Calendar.WEDNESDAY){
				return currentday+Calendar.WEDNESDAY-currentDayOfaWeek + addDays1 + 7;
			}else{
				return currentday+Calendar.WEDNESDAY-currentDayOfaWeek + addDays2 ;
			}
		}else if(dayofweek.equals("thur")||dayofweek.equals("thursday")){
			if(currentDayOfaWeek>Calendar.THURSDAY){
				return currentday+Calendar.THURSDAY-currentDayOfaWeek + addDays1  + 7;
			}else{
				return currentday+Calendar.THURSDAY-currentDayOfaWeek + addDays2 ;
			}
		}else if(dayofweek.equals("fri")||dayofweek.equals("friday")){
			if(currentDayOfaWeek>Calendar.FRIDAY){
				return currentday+Calendar.FRIDAY-currentDayOfaWeek + addDays1  + 7;
			}else{
				return currentday+Calendar.FRIDAY-currentDayOfaWeek + addDays2 ;
			}
		}else if(dayofweek.equals("sat")||dayofweek.equals("saturday")){
			if(currentDayOfaWeek>Calendar.SATURDAY){
				return currentday+Calendar.SATURDAY-currentDayOfaWeek + addDays1  + 7;
			}else{
				return currentday+Calendar.SATURDAY-currentDayOfaWeek + addDays2 ;
			}
		}else if(dayofweek.equals("sun")||dayofweek.equals("sunday")){
			if(currentDayOfaWeek>Calendar.SUNDAY){
				return currentday+Calendar.SUNDAY-currentDayOfaWeek + addDays1  + 7;
			}else{
				return currentday+Calendar.SUNDAY-currentDayOfaWeek + addDays2 ;
			}
		}else{
			return currentday;
		}	
