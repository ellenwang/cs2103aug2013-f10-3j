...
import googlesync.ServiceNotAvailableException;
import googlesync.GCalCommand;
...
public class GoogleCalendar {
	...
	GSyncDAO gSyncDao = null;
	GoogleParser gParser = null;
	private boolean isAuthorized;
	private String feedback = null;
	GoogleCalendar(){
		gSyncDao = new GSyncDAO();
	...
	public String chooseCalendar() throws Exception{
		// CalendarList
	...
	public Vector<TaskItem> sync(Vector<TaskItem> allTasks, String calendarId) throws ServiceNotAvailableException{
		...
		try {
			...
			allTasks = gSyncDao.removeDuplicates(allTasks);
			
			for (TaskItem task : allTasks) {
				if(!gSyncDao.isExisted(task, tasksFromGoogle)){
